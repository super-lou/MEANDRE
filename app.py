...
@app.route('/')
@app.route('/plus-d-eau-d-moins-eau/disparite-sur-le-territoire')
@app.route('/plus-d-eau-d-moins-eau/l-approche-multi-modeles')
@app.route('/plus-d-eau-d-moins-eau/les-trajectoires')
@app.route('/plus-d-eau-d-moins-eau/les-narratifs')
@app.route('/l-incertitude-des-crues/le-regime-des-crues')
@app.route('/l-incertitude-des-crues/ou-est-la-limite')
@app.route('/l-incertitude-des-crues/des-futurs-incertains')
@app.route('/la-peur-du-manque/le-regime-des-etiages')
@app.route('/la-peur-du-manque/l-intensite')
@app.route('/la-peur-du-manque/la-duree')
@app.route('/la-peur-du-manque/le-constat')
